...
class Dataset:
    ...
    def load(self, img_rows=IMAGE_SIZE, img_cols=IMAGE_SIZE,
        ...
        if K.image_data_format() == 'channels_first':#image_dim_ordering() == 'th':
...
class Model:
    ...
    MODEL_PATH = r'C:\Users\Administrator\Desktop/data/'
...
if __name__ == '__main__':
    dataset = Dataset(r'C:\Users\Administrator\Desktop/data/')
    dataset.load()
...
if __name__ == '__main__':
    ...
    model.build_model(dataset)
    model.train(dataset)
    model.save_model(file_path=r'C:\Users\Administrator\Desktop/data/liuyang.face.model.h5')
...
if __name__ == '__main__':
    ...
    # 评估模型
    model = Model()
    model.load_model(file_path=r'C:\Users\Administrator\Desktop/data/liuyang.face.model.h5')
